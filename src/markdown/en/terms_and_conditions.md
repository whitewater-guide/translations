Please read these **Terms and Conditions** ("Terms", "Terms and Conditions") carefully before using the Whitewater Guide mobile application (the "Application") operated by the Whitewater Guide team ("us", "we", or "our").
